...
export function Header({ cartCount = 0, phone = "+7 (383) 000-00-00" }: HeaderProps) {
  ...
  const dark = scrolled;
  const textColor = dark ? "var(--color-text-on-dark)" : "var(--color-text)";
  ...
  return (
    <>
      <header
        ...
        style={{
          backgroundColor: dark ? "var(--color-bg-dark)" : "transparent",
          boxShadow: dark ? "0 6px 24px rgba(0,0,0,0.18)" : "none",
        }}
      >
          ...
          >
            ...
            <span
              style={{
                ...
                color: dark ? "var(--color-text-on-dark)" : "var(--color-text-muted)",
                fontWeight: 500,
                fontSize: 13,
